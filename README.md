<p align="center">
  <picture>
    ...
    <img src="docs/assets/cover-light.svg" alt="Nmap Command Builder — Assemble An Nmap Command By Toggling Options, in the Terminal Workbench style" width="100%">
  </picture>
</p>

<p align="center">
  <a href="https://real-fruit-snacks.github.io/nmap-command-builder/"><strong>Live site</strong></a> ·
...
Toggle scan type, ports, detection, timing, and output — the nmap command assembles live, every flag explained, with privilege notes and a copy button. Styled with the
...
**Offline / airgapped:** grab the zip from the [latest release](https://github.com/Real-Fruit-Snacks/nmap-command-builder/releases/latest)
